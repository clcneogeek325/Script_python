...
class tabla:
	...
	self.boton1 = gtk.RadioButton(None, "Activaciion 1")
	self.boton1.connect("clicked", self.mensaje1)
	self.boton2 = gtk.RadioButton(self.boton1, "Activaciion 2")
	self.boton2.connect("clicked", self.mensaje2)
	self.boton3 = gtk.RadioButton(self.boton1,"Activaciion 3")
	...
	if estado == True:
	    print "El boton 1  esta Activado"
	else:
	    print "El boton 1  no esta Activado"
    def mensaje2(self, widget):
	estado =  widget.get_active()
	if estado == True:
	    print "El boton 2  esta Activado"
	else:
	    print "El boton 2 no esta Activado"
    def mensaje3(self, widget):
	estado =  widget.get_active()
	if estado == True:
	    print "El boton 3 esta Activado"
	else:
	    print "El boton 3 no esta Activado"
