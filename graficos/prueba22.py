...
class Base: # se define la clase Base
    ...
    def __init__(self):# el metodo que tendra la ventana
        ...
        self.label1 = gtk.Label("Pallazo.png")
        ...
        self.pixeles = gtk.gdk.pixbuf_new_from_file(self.label1.get_text())
        self.pixeles = self.pixeles.scale_simple(400, 400 , gtk.gdk.INTERP_BILINEAR)
