...
class Base: # se define la clase Base
    ...
    def cambiar(self,widget):
        ...
        self.pixeles = gtk.gdk.pixbuf_new_from_file_at_size("newtux.png", 500, 400)
        self.imagen.set_from_pixf(self.pixeles)
        
    def relabel(self,widget):
        self.label1.set_text("nuevo texyo") 
    ...
    def __init__(self):# el metodo que tendra la ventana
        ...
        self.cambia = gtk.Button("Cambiar imagen")#sele poner nombre al boton esconder
        self.cambia.connect("clicked", self.cambiar)      
        ...
        self.pixeles = gtk.gdk.pixbuf_new_from_file_at_size("look-image.jpg", 500, 400)
        self.imagen = gtk.Image()
        self.imagen.set_from_pixbuf(self.pixeles)

        self.box1 = gtk.HBox()
        self.box1.pack_start(self.cambia)
